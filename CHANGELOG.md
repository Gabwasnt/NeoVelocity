...
## [1.2.6](https://github.com/Gabwasnt/NeoVelocity/compare/v1.2.5...v1.2.6) - 2026-01-15
...
+ Moved to a stone cutter project structure
+ Refactored logging and disconnect messages
...
## [1.2.1](https://github.com/Gabwasnt/NeoVelocity/compare/v1.2.0...v1.2.1) - 2025-04-18
...
## [1.2.0](https://github.com/Gabwasnt/NeoVelocity/compare/v1.1.0...v1.2.0) - 2025-02-13

+ Added a port of CrossStitch
+ Fixed Access Transformers [#7](https://github.com/Gabwasnt/NeoVelocity/issues/7)

## [1.1.0](https://github.com/Gabwasnt/NeoVelocity/compare/v1.0.0...v1.1.0) - 2025-02-09

+ Removed the option to enabled - just remove the mod to disable

## [1.0.0](https://github.com/Gabwasnt/NeoVelocity/compare/v0.0.1...v1.0.0) - 2025-02-08
